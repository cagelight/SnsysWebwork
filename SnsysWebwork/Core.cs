		...
		public static int Main(String[] args) {
			...
			while (true) {
				...
				case "SDB":
					...
					TSDB ["TEST1"] = new IDatablock[] { new StringDatablock("VALUE1"), new FloatDatablock(0.5f) };
					TSDB ["TEST2"] = new IDatablock[] { new ByteDatablock(0x8A), new UShortDatablock(32025) };
					TSDB.Write ("test.sdb");
					TSDB.Debug ();
					break;
				default:
